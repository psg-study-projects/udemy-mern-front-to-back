...
// %FIXME: DRY see AddExperience
const AddEducation = ({ addEducation, history }) => {

    // useState hook vs classes %TODO
    const [formData, setFormData] = useState({
        school: '',
        degree: '',
        fieldofstudy: '',
        from: '',
        to: '', // disableif current is true
        current: false,
        description: ''
    });
    ...
    return (
        ...
        <Fragment>
            ...
            <p className="lead"> <i className="fas fa-code-branch"></i> Add any school or bootcamp you have attended </p>
            <small>* = required field</small>
            <form className="form" onSubmit={e => { 
                e.preventDefault();
                addEducation(formData, history); // call action
            }}
            >
